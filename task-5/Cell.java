...
public class Cell {
    ...
    // constructs cell at given row and column on board
    public Cell(int row, int column) {
        this.row = row;
        this.column = column;
    }

    // returns column in which cell is located
    public int getColumn() {
        return column;
    }

    // returns row in which cell is located
    public int getRow() {
        return row;
    }

    // returns horizontal screen coordinate of top-left corner of cell
    public int getScreenHorizontalCoord() {
        return column * CELL_PIXELS;
    }

    // returns vertical screen coordinate of top-left corner of cell
